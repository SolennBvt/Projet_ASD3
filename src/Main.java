...
public class Main {
    ...
    public static void createQuadtree(String path){
        ...
        try{
            ...
            qdTree = new Quadtree(png, 0, 0, png.height(), null);
    ...
    public static long delta(int valeur){
        qdTree_delta = new Quadtree(png, 0, 0, png.height(), null);
    ...
    public static long phi(int valeur){
        qdTree_phi = new Quadtree(png, 0, 0, png.height(), null);
        long lStartTime = System.nanoTime();
    ...
    public static void testResultRep(){
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            if(args.length == 0) {
                ...
                while(num != 7){ // 7 -> Arrêter le programme
                ...
                prevCompress = 1 ;
                long outputDelta = delta(delta);
                saveToPNG(delta);
                saveToTXT(delta);

                prevCompress = 2 ;

                long outputPhi = phi(phi);
                ...
                System.out.println("delta : rapport de poids = "+wD+"% / qualité = "+siD+"% / temps d'éxécution en milisecondes "+outputDelta/1000000 );
                System.out.println("phy : rapport de poids = "+wP+"% / qualité = "+siP+"% / temps d'éxécution en milisecondes "+outputPhi/1000000 );
